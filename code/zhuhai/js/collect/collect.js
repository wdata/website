...
$(function(){
    ...
    for(var i=0;i<images.length;i++){
        html+="<li class='pic"+(i+1)+"'><a href='https://www.baidu.com/'><div class='title'>我是标题"+(i+1)+"</div><img src='"+images[i].src+"'/><i></i></a><div class='footer'><div class='like'><i class='icon'><img src='../images/collect/shoucang.png' alt=''></i><span>1453</span></div><div class='title'>主体责任</div></div></li>";
    }
    $("#pic>ul").html(html);
    $(".footer>.like>.icon").tap(function(){
        $(this).children("img").attr("src","../images/collect/sc.png");
    });
    ...
    for(var i= length+1;i<images.length;i++){
        ...
        h++;
        to+=7;
        //"width": (100-(wid*10))+"%",-moz-transform:scale(2,2);
