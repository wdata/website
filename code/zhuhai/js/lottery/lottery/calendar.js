    ...
    Calendar.prototype.init = function() {
        ...
        this.createHeader(function() {
            ...
            var div =  '<div class="prompt">已经连续签到<span>3</span>天哦~</div>'+
				'<div class="hear"><img class="left" src="../images/lottery/button.png" /><img class="right" src="../images/lottery/button.png" /></div>'
            $(oCalen).append(div);
    ...
    Calendar.prototype.createHeader = function(cb) {
        ...
        var month = create('div', {
            ...
            prevMonth = create('a', {
                ...
                '<img src="../images/lottery/return.png" />'),
            nextMonth = create('a', {
...
//      header.appendChild(year);
    ...
    Calendar.prototype.createWeek = function() {
        ...
        var qiandao = '<div class="qiandao"><a class="qian" onclick='+'qiandao()'+'><img src="../images/lottery/qiandao.png" /><span>签到</span><span class="yes hide">已签到</span></a></div>'
