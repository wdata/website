...
$.fn.xb_scroll = function(options)
{
	...
	var jqScrollBox = $("<div style='position:absolute;width:"+opts.boxWidth+"px;top:"+opts.barOffTop+"px;right:"+opts.barOffRight+"px;bottom:"+opts.barOffBottom+"px;border-radius: 5px;background: rgba(0,0,0,0.5);'></div>");
	jqScrollBox.addClass(opts.boxClass);
	var jqScrollBar= $("<div style='position:absolute;width:"+opts.barWidth+"px;top:"+opts.barOffTop+"px;right:"+opts.barOffRight+"px;border-radius: 5px;background: rgba(0,0,0,0.1);'></div>");
	...
	jqScrollBar.on("mousedown",function(ev){
		...
		jqScrollBar.css({"background":"rgba(0,0,0,0.1)"});
	...
	$(document).on("mouseup",function(ev){	
		...
		jqScrollBar.css({"background":"rgba(0,0,0,0.3)"});
		isS_B = false;	
	});	
