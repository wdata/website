...
var DataIndexes = {
    ...
    inAjax:function(d,id){
        ...
        console.log(id,$(".chart-type-val span").attr("data-type"))
        self.draw(id,parseInt($(".chart-type-val span").attr("data-type")));
        // $.ajax({
        //     type:"post",
...
var lineData = {
    "value": [[388, 581, 540, 434, 542, 438], [1495121843, 1636049239, 1515649944, 1815432755, 1636049348, 1495631745], [
        1819, 2750, 2310, 1901, 2551, 2426]],
    "x-axis": ["内存", "显示器", "机箱", "硬盘", "键盘", "鼠标"],
    "y-axis": ["数量", "城市编号", "金额"]
};
...
var pieData = [["内存", 388], ["显示器", 581], ["机箱", 540], ["硬盘", 434], ["键盘", 542], ["鼠标", 438]]
...
var manyData = {
    ...
    "charts": {
        "meaAxis": "y",
        "dimTitle": "产品名称",
        "dimValues": [["内存", "显示器", "机箱", "硬盘", "键盘", "鼠标"]],
        "meaList": [{
            "meaTitle": "金额",
            "maxValue": 2750,
            "meaValues": [[[1819, 2750, 2310, 1901, 2551, 2426]]]
        }, {
            "meaTitle": "数量",
            "maxValue": 581,
            "meaValues": [[[388, 581, 540, 434, 542, 438]]]
        }]
    }
}
var tableDat = [{
