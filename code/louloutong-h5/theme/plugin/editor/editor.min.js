$.fn.extend({
	...
	compressHandler: function(e) {
		var t, a = document.createElement("canvas"),
			...
			l = e.height;
		(t = n * l / 4e6) > 1 ? (t = Math.sqrt(t), n /= t, l /= t) : t = 1, a.width = n, a.height = l, r.fillStyle = "#fff", r.fillRect(0, 0, a.width, a.height);
		var s;
		if ((s = n * l / 1e6) > 1) {
			s = ~~ (Math.sqrt(s) + 1);
			var c = ~~ (n / s),
			...
			for (var d = 0; d < s; d++) for (var g = 0; g < s; g++) i.drawImage(e, d * c * t, g * p * t, c * t, p * t, 0, 0, c, p), r.drawImage(o, d * c, g * p, c, p)
	...
	insertImage: function(e) {
		...
		if (this.range ? (t = this.range, this.range = null) : t = a.createRange ? a.createRange() : a.getRangeAt(0), window.getSelection) {
			...
			t.insertNode(t.createContextualFragment("<br/>")), t.insertNode(r), o && (t.setEndAfter(o), t.setStartAfter(o)), a.removeAllRanges(), a.addRange(t)
