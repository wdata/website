...
/******/ 	__webpack_require__.p = "http://localhost:6368/dist/";
/******/
...
module.exports = __webpack_require__.p + "./img/6aadae320c99299a9b41f43bed05f5e7.jpg";
...
window.particlesJS=function(g,f){if(typeof(g)!="string"){f=g;g="particles-js"}if(!g){g="particles-js"}var a=document.getElementById(g),e="particles-js-canvas-el",c=a.getElementsByClassName(e);if(c.length){while(c.length>0){a.removeChild(c[0])}}var d=document.createElement("canvas");d.className=e;d.style.width="100%";d.style.height="100%";var b=document.getElementById(g).appendChild(d);if(b!=null){pJSDom.push(new pJS(g,f))}};;

window.particlesJS.load=function(d,a,b){var c=new XMLHttpRequest();c.open("GET",a);c.onreadystatechange=function(e){if(c.readyState==4){if(c.status==200){var f=JSON.parse(e.currentTarget.response);window.particlesJS(d,f);if(b){b()}}else{console.log("Error pJS - XMLHttpRequest status: "+c.status);console.log("Error pJS - File config not found")}}};c.send()};;
